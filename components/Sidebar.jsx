...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between pt-7 bg-[#212327] transition-all z-50 max-md:absolute max-md:h-screen ${expand ? "p-4 w-64" : "md:w-20 w-0 max-md:overflow-hidden"
        }`}
    >
      <div>
        <div
        ...
        >
          ...
          >
            ...
            />
            <div
              className={`w-max absolute ${expand ? "left-1/2 -translate-x-1/2 top-12" : "-top-12 left-0"
